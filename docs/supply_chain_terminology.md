...
**Inventory Management System (IMS)**: A software/hardware system which manages inventory within and across warehouses, DCs and FCs. For more info, refer to [this link](https://www.argosoftware.com/blog/guide-to-warehouse-inventory-management/) and [10 types of Inventory Management](https://www.thomasnet.com/insights/types-of-inventory-management/).
